<template>
  <v-row align="center" justify="center" >
    ...
    <v-col cols='6'>
      <v-card>
        <v-card-text>
          <line-chart :chart-data="chartData.pressure"  :options="{responsive: true, maintainAspectRatio: false}"></line-chart>
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols='6'>
    ...
    <v-col cols='6'>
      <v-card>
        <v-card-text>
          <line-chart :chart-data="chartData.dioxide"  :options="{responsive: true, maintainAspectRatio: false}"></line-chart>
        </v-card-text>
      </v-card>
    </v-col>
  </v-row>
